...
SRC_URI="docker-util-release-1.6.0.tar.gz
...
pkg_nofetch() {
	elog "Please obtain docker-util-release-1.6.0.tar.gz from Ultinous and place it inside ${DISTDIR}"
}

src_prepare() {
	default
	rm -rf ${S}
	mv ${WORKDIR}/docker-util-release-1.6.0 ${S}
	mkdir ${COMPDIR}
}
