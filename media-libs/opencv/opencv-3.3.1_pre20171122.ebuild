...
inherit git-r3 toolchain-funcs python-r1 java-pkg-opt-2 java-ant-2 cmake-multilib

DESCRIPTION="A collection of algorithms and sample code for various computer vision problems"
HOMEPAGE="https://opencv.org"
EGIT_REPO_URI="https://github.com/opencv/opencv.git"
EGIT_COMMIT="3.3.1"
SRC_URI="https://dev.gentoo.org/~amynka/snap/imgcodecs-opencv-3.3.0.tar.gz"

LICENSE="BSD"
SLOT="0/3.3" # subslot = libopencv* soname version
KEYWORDS="~amd64 ~arm ~arm64 ~ppc ~ppc64 ~x86 ~amd64-linux"
IUSE="cuda debug +eigen examples ffmpeg gdal gflags glog gphoto2 gstreamer gtk ieee1394 ipp jpeg jpeg2k lapack libav opencl openexr opengl openmp pch png +python qt5 tesseract testprograms threads tiff vaapi v4l vtk webp xine "
