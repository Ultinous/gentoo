...
NV_MODPROBE_VER_NUM="450.57"
NV_MODPROBE_VER="nvidia-modprobe-${NV_MODPROBE_VER_NUM}"
...
SRC_URI="(
	...
	https://github.com/NVIDIA/nvidia-modprobe/archive/${NV_MODPROBE_VER_NUM}.tar.gz -> ${NV_MODPROBE_VER}.tar.gz
)"
